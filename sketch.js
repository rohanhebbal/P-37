...
B.position(425,100)
C=createElement("h2")
C.html("Q1) What are the five colours of the Olympic rings?");
C.position(50,200)
D=createElement("h2")
D.html("a) blue, red, pink, yellow and orange")
D.position(50,250)
E=createElement("h2")
E.html("b) pink, green, white, black and yellow")
E.position(50,300)
G=createElement("h2")
G.html("c) blue, yellow, black, green and red");
G.position(50,350)
I=createElement("h2")
I.html("d) blue, green, black, red and pink");
I.position(50,400)
bp=createButton("SUBMIT")
bp.position(100,550)
